...
const campingSites = [
  {
    id: 1,
    title: 'Mountain View Site',
    description: 'Premium camping spot with panoramic mountain views',
    price: 50,
    ...
    features: ['Mountain view', 'Fire pit', 'Picnic table', 'Water access'],
    capacity: 6,
  },
  {
    id: 2,
    title: 'Riverside Camp',
    description: 'Peaceful camping area along the river',
    price: 45,
    ...
    features: ['River access', 'Shaded area', 'BBQ grill', 'Parking spot'],
    capacity: 4,
  },
  {
    id: 3,
    title: 'Forest Retreat',
    description: 'Secluded camping spot in our private forest',
    price: 40,
    ...
    features: ['Forest view', 'Privacy', 'Fire ring', 'Tent platform'],
    capacity: 4,
  },
]
    ...
    <section id="camping" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-black mb-4">Camping Sites</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Connect with nature in our beautiful camping areas. Each site offers unique
            features and stunning views of the surrounding landscape.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {campingSites.map((site) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-black mb-2">{site.title}</h3>
