        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0">
              <Link 
                to="/"
                className="text-lime-400 font-bold text-xl font-display"
              >
                RIF LAND
              </Link>
            </div>
                  ...
                  return (
                    <Link
                      ...
                      className={`relative py-2 text-sm font-medium ${
                        isActive ? 'text-lime-400' : 'text-gray-400 hover:text-lime-400'
                      }`}
                    >
                      {item.label}
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute bottom-0 inset-x-0 h-0.5 bg-lime-400"
            ...
            <div className="hidden md:flex items-center space-x-6 rtl:space-x-reverse">
              ...
              <button
                ...
                className="relative p-2 text-gray-400 hover:text-lime-400"
              ...
              >
                ...
                {itemCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-lime-400 text-black text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                    {itemCount}
                  </span>
                )}
              </button>
